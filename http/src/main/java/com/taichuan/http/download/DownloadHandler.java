...
public class DownloadHandler {
    ...
    public DownloadHandler(String url, WeakHashMap<String, Object> params, String dir, String extension, String name, IRequest request, ISuccess success, IFailure failure, IError error) {
        this.URL = url;
        this.PARAMS = params;
        this.DIR = dir;
